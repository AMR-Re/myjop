                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex flex-row align-items-center">
                        <div class="icon"> 
                           ...
                           <a href="{{route('company',[$employer->id])}}"><img src="{{Storage::url($employer->profile->profile_pic)}}" width="50"></a>
                            @else 
    ...
    <div class="row mt-2 g-1">
        ...
        <div class="col-md-3">
            <div class="card p-2 {{$job->job_type}}">
                ...
                <div class="text-center mt-2 p-3"> <img class="rounded-circle" width="50" src="/icons8-netflix-50.png"  alt= 'image' width="100" /> <br>
    ...
    <div class="container p-4">
      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
          ...
          <p>
        join us with our journey to mitigate .....
          </p>
        ...
        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="fa-ul" style="margin-left: 1.65em;">
            <li class="mb-3">
              <span class="fa-li"><i class="fas fa-home"></i></span><span class="ms-2">Dubai,UAE</span>
            </li>
            <li class="mb-3">
